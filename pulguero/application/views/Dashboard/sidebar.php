<nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link"  href="http://[::1]/pulguero/index.php/Usuarios/listadoUsuarios">
              <span class="menu-icon">
                <i class="mdi mdi-laptop"></i>
              </span>
              <span class="menu-title">Lista usuarios</span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="http://[::1]/pulguero/index.php/Usuarios/register">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="http://[::1]/pulguero/index.php/Usuarios/crear_cuenta">
              <span class="menu-icon">
