...
<html lang="en">
  ...
  <body>
              ...
              <div class="col-lg-6 grid-margin stretch-card" style="width: 50%; margin: auto; text-align: center;">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                      <div class="text-md-center text-xl-left">
                        <h6 class="mb-1">Medias</h6>
                      </div>
                      <div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                        <h6 class="font-weight-bold mb-0">120</h6>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <script src="<?php echo base_url();?>assets/js/otros.js"></script>
    <!-- endinject -->
